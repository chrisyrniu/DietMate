  ...
  for i in range(0,labelSet.shape[0]):
      ...
      if label_flag == labelSet[i]:
         ...
         if label_flag == 0:
            ...
            if talking_count == 1:
               red = plt.plot(range(segment_flag-1,i+1),segment,'r',label='Talking')
            else:
               plt.plot(range(segment_flag-1,i+1),segment,'r')
         if label_flag == 1:
            opening_count = opening_count+1
            if opening_count == 1:
               green = plt.plot(range(segment_flag-1,i+1),segment,'g',label='Opening')
            else:
               plt.plot(range(segment_flag-1,i+1),segment,'g')
         if label_flag == 2:
            chewing_count = chewing_count+1
            if chewing_count == 1:
               blue = plt.plot(range(segment_flag-1,i+1),segment,'b',label='Chewing')
            else:
               plt.plot(range(segment_flag-1,i+1),segment,'b')
         if label_flag == 3:
            swallowing_count = swallowing_count+1
            if swallowing_count == 1:
               orange = plt.plot(range(segment_flag-1,i+1),segment,'orange',label='Swallowing')   
            else:
               plt.plot(range(segment_flag-1,i+1),segment,'orange')       
         if label_flag == 4:
            other_count = other_count+1
            if other_count == 1:
               yellow = plt.plot(range(segment_flag-1,i+1),segment,'yellow',label='Other')   
            else:
      ...
      if i == labelSet.shape[0]-1:
         if label_flag == 0:
            talking_count = talking_count+1
            if talking_count == 1:
               red = plt.plot(range(segment_flag-1,i+2),segment,'r',label='Talking')
            else:
               plt.plot(range(segment_flag-1,i+2),segment,'r')
         if label_flag == 1:
            opening_count = opening_count+1
            if opening_count == 1:
               green = plt.plot(range(segment_flag-1,i+2),segment,'g',label='Opening')
            else:
               plt.plot(range(segment_flag-1,i+2),segment,'g')
         if label_flag == 2:
            chewing_count = chewing_count+1
            if chewing_count == 1:
               blue = plt.plot(range(segment_flag-1,i+2),segment,'b',label='Chewing')
            else:
               plt.plot(range(segment_flag-1,i+2),segment,'b')
         if label_flag == 3:
            swallowing_count = swallowing_count+1
            if swallowing_count == 1:
               orange = plt.plot(range(segment_flag-1,i+2),segment,'orange',label='Swallowing')   
            else:
               plt.plot(range(segment_flag-1,i+2),segment,'orange')       
         if label_flag == 4:
            other_count = other_count+1
            if other_count == 1:
               yellow = plt.plot(range(segment_flag-1,i+2),segment,'yellow',label='Other')   
            else:
               plt.plot(range(segment_flag-1,i+2),segment,'yellow') 
  plt.legend((red[0], green[0], blue[0], orange[0], yellow[0]), ('Talking', 'Opening', 'Chewing', 'Swallowing', 'Other'))    
  plt.xlim(xRange)
  plt.xlabel("Sequence")
  plt.ylabel("Label")
...
# Plot colored sensor data
def draw_sensorData(sensorData, labelSet, prediction, xRange):
  # Plot the sensor data with actual labels 
  ...
  for i in range(0,sensorData.shape[0]):
      ...
      if label_flag == labelSet[i]:
         ...
         if label_flag == 0:
            talking_count = talking_count+1
            if talking_count == 1:
               red = plt.plot(range(segment_flag,i+1),segment,'r',label='Talking')
            else:
               plt.plot(range(segment_flag,i+1),segment,'r')
         if label_flag == 1:
            opening_count = opening_count+1
            if opening_count == 1:
               green = plt.plot(range(segment_flag,i+1),segment,'g',label='Opening')
            else:
               plt.plot(range(segment_flag,i+1),segment,'g')
         if label_flag == 2:
            chewing_count = chewing_count+1
            if chewing_count == 1:
               blue = plt.plot(range(segment_flag,i+1),segment,'b',label='Chewing')
            else:
               plt.plot(range(segment_flag,i+1),segment,'b')
         if label_flag == 3:
            swallowing_count = swallowing_count+1
            if swallowing_count == 1:
               orange = plt.plot(range(segment_flag,i+1),segment,'orange',label='Swallowing')   
            else:
               plt.plot(range(segment_flag,i+1),segment,'orange')       
         if label_flag == 4:
            other_count = other_count+1
            if other_count == 1:
               yellow = plt.plot(range(segment_flag,i+1),segment,'yellow',label='Other')   
            else:
      ...
      if i == sensorData.shape[0]-1:
         if label_flag == 0:
            talking_count = talking_count+1
            if talking_count == 1:
               red = plt.plot(range(segment_flag,i+2),segment,'r',label='Talking')
            else:
               plt.plot(range(segment_flag,i+2),segment,'r')
         if label_flag == 1:
            opening_count = opening_count+1
            if opening_count == 1:
               green = plt.plot(range(segment_flag,i+2),segment,'g',label='Opening')
            else:
               plt.plot(range(segment_flag,i+2),segment,'g')
         if label_flag == 2:
            chewing_count = chewing_count+1
            if chewing_count == 1:
               blue = plt.plot(range(segment_flag,i+2),segment,'b',label='Chewing')
            else:
               plt.plot(range(segment_flag,i+2),segment,'b')
         if label_flag == 3:
            swallowing_count = swallowing_count+1
            if swallowing_count == 1:
               orange = plt.plot(range(segment_flag,i+2),segment,'orange',label='Swallowing')   
            else:
               plt.plot(range(segment_flag,i+2),segment,'orange')       
         if label_flag == 4:
            other_count = other_count+1
            if other_count == 1:
               yellow = plt.plot(range(segment_flag,i+2),segment,'yellow',label='Other')   
            else:
  ...
  # Plot the sensor data with the estimated labels.
  plt.subplot(2, 1, 2)
